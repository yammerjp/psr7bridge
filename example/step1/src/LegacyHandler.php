...
use Yammerjp\Psr7bridge\Psr7IncompatibleHandlerInterface;
use SQLite3;

class LegacyHandler implements Psr7IncompatibleHandlerInterface
{
...
<body>
    ...
    <nav>
        ";
            foreach($this->listPages($db) as $page) {
    ...
    */
    private function handleAddPage($db)
    {
